...
var facemesh = require("./index");
var test_util_1 = require("./test_util");
jasmine_util_1.describeWithFlags('Facemesh', jasmine_util_1.ALL_ENVS, function () {
    var model;
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, facemesh.load()];
                case 1:
    ...
    it('estimateFaces does not leak memory', function () { return __awaiter(_this, void 0, void 0, function () {
        var input, numTensors, returnTensors, flipHorizontal, returnIrises;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, model.estimateFaces(input, returnTensors, flipHorizontal)];
                case 1:
                    _a.sent();
                ...
                case 3:
                    ...
                    flipHorizontal = true;
                    returnIrises = true;
                    return [4 /*yield*/, model.estimateFaces(input, returnTensors, flipHorizontal, returnIrises)];
                case 4:
                    _a.sent();
                    expect(tf.memory().numTensors).toEqual(numTensors);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // from memory test.
                    return [4 /*yield*/, model.estimateFaces(input, false /* return tensors */, false /* return tensors */, true /* predict irises */)];
                case 1:
                    // Call estimateFaces once up front to exclude any initialization tensors
                    // from memory test.
                    _a.sent();
                    numTensors = tf.memory().numTensors;
                    return [4 /*yield*/, model.estimateFaces(input)];
                case 2:
                    result = _a.sent();
                    face = result[0];
                    expect(tf.memory().numTensors).toEqual(numTensors);
