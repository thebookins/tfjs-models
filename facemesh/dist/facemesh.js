...
(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */
    function load$1(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.maxContinuousChecks, maxContinuousChecks = _c === void 0 ? 5 : _c, _d = _b.detectionConfidence, detectionConfidence = _d === void 0 ? 0.9 : _d, _e = _b.maxFaces, maxFaces = _e === void 0 ? 10 : _e, _f = _b.iouThreshold, iouThreshold = _f === void 0 ? 0.3 : _f, _g = _b.scoreThreshold, scoreThreshold = _g === void 0 ? 0.75 : _g, _h = _b.shouldLoadIrisModel, shouldLoadIrisModel = _h === void 0 ? true : _h;
        return __awaiter(this, void 0, void 0, function () {
            var models, faceMesh;
    ...
    var FaceMesh = /** @class */ (function () {
         ...
         */
        FaceMesh.prototype.estimateFaces = function (input, returnTensors, flipHorizontal, predictIrises) {
            if (returnTensors === void 0) { returnTensors = false; }
            if (flipHorizontal === void 0) { flipHorizontal = false; }
            if (predictIrises === void 0) { predictIrises = true; }
            return __awaiter(this, void 0, void 0, function () {
