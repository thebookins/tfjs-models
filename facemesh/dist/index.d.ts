 ...
 * Defaults to true.
 */
export declare function load({ maxContinuousChecks, detectionConfidence, maxFaces, iouThreshold, scoreThreshold, shouldLoadIrisModel }?: {
...
export declare class FaceMesh {
     ...
     */
    estimateFaces(input: tf.Tensor3D | ImageData | HTMLVideoElement | HTMLImageElement | HTMLCanvasElement, returnTensors?: boolean, flipHorizontal?: boolean, predictIrises?: boolean): Promise<AnnotatedPrediction[]>;
}
export {};
